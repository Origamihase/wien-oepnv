...
| Durchschnittliche Verspätung | 13.3 min |
| Kritische Verspätungen (> 9 min) | 1 |
| Letzte Aktualisierung | 2026-07-20 01:31 CEST |
...
| Kennzahl | Wert |
| -------- | ---- |
| Beobachtungen (gesamt) | 2.546 |
| Durchschnittliche Verspätung | 1.1 min |
| Kritische Verspätungen (> 9 min) | 36 |
| Letzte Aktualisierung | 2026-07-20 01:31 CEST |
...
| -------- | ---- |
| Ausfälle (gesamt) | 655 |
| Häufigste Linien | S1 (180), S3 (112), REX3 (100) |
| Letzte Aktualisierung | 2026-07-20 01:31 CEST |
<!-- STATS:AUSFAELLE:END -->
