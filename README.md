...
| Durchschnittliche Verspätung | 3.4 min |
| Kritische Verspätungen (> 9 min) | 0 |
| Letzte Aktualisierung | 2026-07-01 10:31 CEST |
...
| Kennzahl | Wert |
| -------- | ---- |
| Beobachtungen (gesamt) | 2.678 |
| Durchschnittliche Verspätung | 1.4 min |
| Kritische Verspätungen (> 9 min) | 23 |
| Letzte Aktualisierung | 2026-07-01 10:31 CEST |
...
| -------- | ---- |
| Ausfälle (gesamt) | 798 |
| Häufigste Linien | S1 (244), S3 (158), REX3 (117) |
| Letzte Aktualisierung | 2026-07-01 10:31 CEST |
<!-- STATS:AUSFAELLE:END -->
