...
| Durchschnittliche Verspätung | 13.0 min |
| Kritische Verspätungen (> 9 min) | 1 |
| Letzte Aktualisierung | 2026-07-17 01:31 CEST |
...
| Kennzahl | Wert |
| -------- | ---- |
| Beobachtungen (gesamt) | 2.560 |
| Durchschnittliche Verspätung | 1.2 min |
| Kritische Verspätungen (> 9 min) | 33 |
| Letzte Aktualisierung | 2026-07-17 01:31 CEST |
...
| -------- | ---- |
| Ausfälle (gesamt) | 717 |
| Häufigste Linien | S1 (201), S3 (139), REX3 (108) |
| Letzte Aktualisierung | 2026-07-17 01:31 CEST |
<!-- STATS:AUSFAELLE:END -->
