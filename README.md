...
| Durchschnittliche Verspätung | 19.2 min |
| Kritische Verspätungen (> 9 min) | 1 |
| Letzte Aktualisierung | 2026-07-28 06:00 CEST |
...
| Kennzahl | Wert |
| -------- | ---- |
| Beobachtungen (gesamt) | 2.458 |
| Durchschnittliche Verspätung | 1.0 min |
| Kritische Verspätungen (> 9 min) | 34 |
| Letzte Aktualisierung | 2026-07-28 06:00 CEST |
...
| -------- | ---- |
| Ausfälle (gesamt) | 450 |
| Häufigste Linien | S1 (112), CJX9 (98), S3 (65) |
| Letzte Aktualisierung | 2026-07-28 06:00 CEST |
<!-- STATS:AUSFAELLE:END -->
