...
2. **Abhängigkeiten installieren**:
   ...
   ```
3. **Statische Analysen**: Die CI führt `ruff check` und `mypy` aus; lokal spiegelst du das Verhalten mit `python -m pip install ruff mypy` und `scripts/run_static_checks.py`.
