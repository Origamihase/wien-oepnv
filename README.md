...
**Dashboard:** Die vollständige Auswertung inkl. Heatmaps und Trend-Linien findest du hier: [**📊 Zum detaillierten Dashboard**](docs/statistik.md)
...
| Kennzahl | Wert |
| -------- | ---- |
| Beobachtungen (gesamt) | 43 |
| Durchschnittliche Verspätung | 0.1 min |
| Kritische Verspätungen (> 9 min) | 0 |
| Letzte Aktualisierung | 2026-05-11 01:30 CEST |
