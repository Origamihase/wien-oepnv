...
| Durchschnittliche Verspätung | 44.0 min |
| Kritische Verspätungen (> 9 min) | 1 |
| Letzte Aktualisierung | 2026-09-09 02:01 CEST |
...
| Kennzahl | Wert |
| -------- | ---- |
| Beobachtungen (gesamt) | 1.368 |
| Durchschnittliche Verspätung | 0.7 min |
| Kritische Verspätungen (> 9 min) | 20 |
| Letzte Aktualisierung | 2026-09-09 02:01 CEST |
...
| -------- | ---- |
| Ausfälle (gesamt) | 419 |
| Häufigste Linien | S2 (150), CJX9 (145), S4 (114) |
| Letzte Aktualisierung | 2026-09-09 02:01 CEST |
<!-- STATS:AUSFAELLE:END -->
