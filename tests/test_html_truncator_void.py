...
def test_truncate_html_void_elements() -> None:
...
def test_truncate_html_img_tag() -> None:
...
def test_truncate_html_nested_void() -> None:
...
def test_truncate_html_ignores_case() -> None:
