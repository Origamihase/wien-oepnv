...
def test_is_relevant_db_bauarbeiten():
    title = "DB-Bauarbeiten ↔ Umleitung/Haltausfall: Linz/Donau Passau"
    desc = "Wegen Bauarbeiten der Deutschen Bahn (DB) wird von 22.04. auf 23.04.2026 der Zug NJ 498 über Salzburg Hbf umgeleitet und kann daher in Passau Hbf und Regensburg Hbf nicht halten.<br/>[Seit 03.03.2026]"
