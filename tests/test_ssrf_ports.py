...
def test_validate_http_url_blocks_unsafe_ports() -> None:
...
def test_validate_http_url_allows_standard_ports() -> None:
...
def test_validate_http_url_allows_implicit_ports() -> None:
...
def test_validate_http_url_custom_ports() -> None:
...
def test_validate_http_url_invalid_port_format() -> None:
