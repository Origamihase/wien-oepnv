...
- code:Bf / source:oebb,osm (Pfaffstätten) → missing stop_id 430453300
- code:Ag / source:oebb,osm (Angern) → missing stop_id 430304600
- code:Nh / source:oebb,osm (Hohenau) → missing stop_id 430377800
- code:Pet / source:oebb,osm (Petronell-Carnuntum) → missing stop_id 430453100
- code:Ah / source:oebb,osm (Absdorf-Hippersdorf) → missing stop_id 430300400
- code:Pr / source:oebb,osm (Payerbach-Reichenau) → missing stop_id 430876300
- code:Wgm / source:oebb,osm (Pottenbrunn) → missing stop_id 430455600
- code:Raf / source:oebb,osm (Raasdorf) → missing stop_id 430461300
- code:Raf H1 / source:oebb,osm (Glinzendorf) → missing stop_id 430352700
...
- code:Due / source:oebb,osm (Dürnkrut) → missing stop_id 430331000
- code:Ebr H1 / source:oebb,osm (Weigelsdorf) → missing stop_id 430515600
- code:Fam / source:oebb,osm (Fischamend) → missing stop_id 430343000
- code:Fld / source:oebb,osm (Felixdorf) → missing stop_id 430341500
- code:Fld H2 / source:oebb,osm (Wiener Neustadt Nord) → missing stop_id 430522300
- code:Glo / source:oebb,osm (Gloggnitz) → missing stop_id 430876100
- code:Gn / source:oebb,osm (Gramatneusiedl) → missing stop_id 430353800
- code:Goe / source:oebb,osm (Götzendorf) → missing stop_id 430365500
- code:Goe H1 / source:oebb,osm (Sarasdorf) → missing stop_id 430468800
- code:Goe H2 / source:oebb,osm (Wilfleinsdorf) → missing stop_id 430523900
- code:Msw / source:oebb,osm (Mannswörth) → missing stop_id 430487500
- code:Guk H2 / source:oebb,osm (Möllersdorf Aspangbahn) → missing stop_id 430430100
- code:Hfa / source:oebb,osm (Hadersdorf am Kamp) → missing stop_id 430366000
