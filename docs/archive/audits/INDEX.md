...
|---|---|---|
| 2026-09-13 | [audit-2026-09-13.md](audit-2026-09-13.md) | Stationsverzeichnis (Funktion + Feed-Anbindung): Verzeichnis und Pipeline gesund, aber zwei feed-sichtbare Fehler in der Statistik-Extraktion — WL-`\| Haltestelle:`-Marker fiel bei 69 % der Beschreibungen aus dem 1024-Zeichen-Suchfenster, generisches „Lokalbahn" kollabierte vier Badner-Bahn-Halte auf Guntramsdorf |
